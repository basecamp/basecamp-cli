...
// SnowglobeLines is how many terminal rows RenderSnowglobe draws. Two raster
// rows share a cell, so a caller budgeting space can ask without rendering.
const SnowglobeLines = snowglobeHeight / 2

// SnowglobeWidth is how many columns RenderSnowglobe draws.
const SnowglobeWidth = snowglobeWidth
